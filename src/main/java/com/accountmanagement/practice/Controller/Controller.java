...
@GetMapping("/findById/{id}")
 ...
 public Accounts addAccounts(@RequestBody CreateAccountReq dto)
 {
     return bankAccountService.addAccount(dto.getName(), dto.getAmount());
 }

 @PutMapping ("/addMoney/{id}")
 public void addMoney(@PathVariable("id") int id, @RequestBody DepositMoneyDto dto) throws AccountNotFoundException
 {
      bankAccountService.addMoney(id, dto.getAmount());
 }

 @PutMapping("/withdraw/{id}")
 public void withdraw(@PathVariable("id") int id, @RequestBody WithdrawAmountReq dto) throws AccountNotFoundException, NotSufficientBalance {
